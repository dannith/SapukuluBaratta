...
public class LevelThree extends LevelBase implements Initializable{
    @FXML
    Pane fxBubbles;
    @FXML
    Pane fxExtraBubbles;
    ...
    final String nextLevel = "level-four.fxml";

    public void initialize(URL url, ResourceBundle resourceBundle) {
        GameManager.sendLevelInfo(fxPlayer, fxBubbles, fxExtraBubbles, xBounderies, yBounderies, levelTimer, fxBarView, this, fxInfoText, false, 3);
    }
